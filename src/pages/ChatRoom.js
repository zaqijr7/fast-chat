...
import { historyInteractions, sendMessage } from '../redux/action/chat'
...
function ChatRoom() {
  ...
  return (
    <div className="row vh-100 m-0 p-0">
      <div className="col-12 chat-room position-relative">
        <div className="row">
          <NavbarChatRoom />
        </div>
        ...
        <div className="row">
          <div className="position-absolute type-chat-area py-3">
