...
function Signin() {
  return (
    <div className="col-12 d-flex justify-content-center align-items-center vh-100 bg-yellow">
      <div className="card card-auth">
        ...
        <div className="card-body">
          ...
          <div className="input-group mb-3 position-relative justify-content-end align-items-center">
            <input type="email" className="form-control py-2" placeholder="Input your email" aria-label="Username" aria-describedby="basic-addon1" />
          ...
          <div className="d-flex justify-content-center">
            <div className="btn btn-info fw-bold text-white">
              Next
